...
const (
	DAYSAFTERBILLDATE_PaymentTermType PaymentTermType = "DAYSAFTERBILLDATE"
	DAYSAFTERBILLMONTH_PaymentTermType PaymentTermType = "DAYSAFTERBILLMONTH"
	OFCURRENTMONTH_PaymentTermType PaymentTermType = "OFCURRENTMONTH"
	OFFOLLOWINGMONTH_PaymentTermType PaymentTermType = "OFFOLLOWINGMONTH"
)
